...
namespace xo {
  namespace option {
    ...
    private:
      PricingContext(utc_nanos t0, double ref_spot, double volatility, double rate)
	: t0_{t0}, ref_spot_{ref_spot}, volatility_{volatility}, rate_{rate} {}

    private:
      /* current time */
      utc_nanos t0_;
      /* underlying spot price */
      double ref_spot_ = 0.0;
